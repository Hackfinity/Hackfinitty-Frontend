  ...
  return (
    <nav className="flex items-center justify-between bg[#b0a3d9] fixed w-full z-10 py-0 px-5">
      <div className="items-center">
        ...
        <h1 className="text-base md:text-lg font-semibold text-custom-purple ml-3 hidden md:block">
          100% on Chain
        </h1>
      </div>
      <div
      ...
      <div
        className={`absolute md:static top-50 md:top-50 left-0 w-full md:w-auto bg-white md:bg-transparent flex flex-col md:flex-row items-center md:items-center transition-all duration-500 ease-in-out ${
